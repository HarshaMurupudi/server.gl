...
router.get("/material/jobsByWorkCenter/:workCenterName", async (req, res) => {
  try {
...
router.get("/material/jobs/open/:workCenterName", async (req, res) => {
  try {
    const { workCenterName } = req.params;
...
router.get("/material/jobs/open/:workCenterName/now-at", async (req, res) => {
  try {
    const { workCenterName } = req.params;
